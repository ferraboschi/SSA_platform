...
export const UI: Record<LangKey, Record<string, string>> = {
  it: {
    ...
    radarTitle: "Profilo della giuria", legendProduct: "Questo prodotto", legendJury: "Media della giuria", sessionsLabel: "Sessioni", categoriesLabel: "Categorie", bannerCollapse: "Comprimi", bannerExpand: "Espandi",
  ...
  en: {
    ...
    radarTitle: "Jury profile", legendProduct: "This product", legendJury: "Jury average", sessionsLabel: "Sessions", categoriesLabel: "Categories", bannerCollapse: "Collapse", bannerExpand: "Expand",
  ...
  ja: {
    ...
    radarTitle: "審査員プロファイル", legendProduct: "この商品", legendJury: "審査員平均", sessionsLabel: "セッション", categoriesLabel: "カテゴリ", bannerCollapse: "折りたたむ", bannerExpand: "展開",
