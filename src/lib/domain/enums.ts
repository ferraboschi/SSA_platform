...
// "guest" = the zero-capability role assigned to an unauthenticated/placeholder
// principal so role checks deny it. Never assigned to a real profile.
export const ROLE_KEYS = ["admin", "manager", "social", "accountant", "guest"] as const;
